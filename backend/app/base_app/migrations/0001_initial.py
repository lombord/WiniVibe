# Generated by Django 4.2.13 on 2024-08-02 19:05

import base_app.models.fields.file_fields
import base_app.models.fields.relational
import base_app.models.fields.string_fields
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image_key', models.CharField(blank=True, max_length=255, null=True, validators=[django.core.validators.RegexValidator(flags=re.RegexFlag['ASCII'], message='Invalid image object key', regex='^[a-f0-9]{40}$')], verbose_name='S3 bucket object key')),
                ('small', base_app.models.fields.file_fields.S3FileField(blank=True, null=True, verbose_name='Small Image')),
                ('medium', base_app.models.fields.file_fields.S3FileField(blank=True, null=True, verbose_name='Medium Image')),
                ('large', base_app.models.fields.file_fields.S3FileField(blank=True, null=True, verbose_name='Large Image')),
                ('extracted_color', base_app.models.fields.string_fields.ColorField(blank=True, null=True, verbose_name='Extracted Color')),
            ],
        ),
        migrations.CreateModel(
            name='Playlist',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('track', models.FileField(max_length=255, upload_to=base_app.models.utils.DynamicPath('users/{track.uploaded_by_id}/tracks/{track.uuid}', ext='.opus', name='track', pass_as='track'), validators=[base_app.models.utils.FileValidator(content_types={'audio/wav', 'audio/x-aiff', 'audio/flac', 'audio/x-m4a', 'audio/ogg', 'audio/mpeg'}, max_size=1073741824), django.core.validators.FileExtensionValidator({'mp2', 'wav', 'mp3', 'alac', 'opus', 'ogg', 'flac', 'aiff'}, 'Invalid audio format valid formats are: mp2, wav, mp3, alac, opus, ogg, flac, aiff')], verbose_name='Track file')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', base_app.models.fields.relational.AutoOneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='profile', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='UserTrackQueue',
        ...
        migrations.CreateModel(
            ...
            bases=('base_app.compressedimage',),
        ),
        migrations.CreateModel(
            name='RoomCoverImage',
            fields=[
        ...
        migrations.AddField(
            ...
            name='header_image',
            field=base_app.models.fields.relational.AutoOneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='base_app.userprofileheaderimage'),
        ),
        migrations.AddField(
            model_name='userprofile',
            name='photo',
            field=base_app.models.fields.relational.AutoOneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='base_app.userprofilephoto'),
        ),
        ...
        migrations.AddField(
            model_name='track',
            name='cover_image',
            field=base_app.models.fields.relational.AutoOneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='base_app.trackcoverimage'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddField(
            model_name='room',
            name='cover_image',
            field=base_app.models.fields.relational.AutoOneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='base_app.roomcoverimage'),
        ),
        migrations.AddConstraint(
            model_name='playlisttrack',
        ...
        migrations.AddField(
            model_name='playlist',
            name='cover_image',
            field=base_app.models.fields.relational.AutoOneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='base_app.playlistcoverimage'),
        ),
        migrations.AddConstraint(
