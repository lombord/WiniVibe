...
class UserManager(DJUserManager):
    ...
    def fetch_public_profile(self) -> UserQuerySet:
        return self.get_queryset().annotate_followers().select_profile()

    def fetch_profile(self) -> UserQuerySet:
        return self.get_queryset().select_profile()

    def fetch_session(self) -> UserQuerySet:
        return self.get_queryset().select_related("profile", "profile__photo")
...
class UserProfile(models.Model):
    ...
    photo = CompImageField(upload_key_path="user/photo")

    header_image = CompImageField(upload_key_path="user/banner")
