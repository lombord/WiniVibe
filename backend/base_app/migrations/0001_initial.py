# Generated by Django 4.2.11 on 2024-03-28 17:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('track', models.FileField(max_length=255, upload_to=base_app.models.utils.DynamicPath('users/{track.uploaded_by_id}/tracks', 'track'), validators=[base_app.models.utils.FileValidator(content_types={'audio/ogg', 'audio/x-aiff', 'audio/wav', 'audio/flac', 'audio/mpeg', 'audio/x-m4a'}, max_size=1073741824), django.core.validators.FileExtensionValidator({'flac', 'wav', 'mp2ogg', 'mp3', 'aiff', 'alac'}, 'Invalid audio format valid formats are: flac, wav, mp2ogg, mp3, aiff, alac')], verbose_name='Track file')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header_image', base_app.models.fields.CompImageField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='base_app.userheaderimage', verbose_name='Profile header image')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='photo',
            field=base_app.models.fields.CompImageField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='base_app.userprofileimage', verbose_name='Compressed photos'),
        ),
        migrations.AddField(
            model_name='userprofile',
            name='user',
        ...
        migrations.AddField(
            model_name='track',
            name='cover_image',
            field=base_app.models.fields.CompImageField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='base_app.trackcoverimage', verbose_name='Track cover image'),
        ),
        migrations.AddField(
            model_name='track',
            name='liked_people',
        ...
        migrations.AddField(
            model_name='room',
            name='cover_image',
            field=base_app.models.fields.CompImageField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='base_app.roomcoverimage', verbose_name='Room cover image'),
        ),
        migrations.AddField(
            model_name='room',
            name='host',
        ...
        migrations.AddField(
            model_name='playlist',
            name='cover_image',
            field=base_app.models.fields.CompImageField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='base_app.playlistcoverimage', verbose_name='Playlist cover image'),
        ),
        migrations.AddField(
            model_name='playlist',
            name='liked_people',
