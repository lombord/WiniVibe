# Generated by Django 4.2.11 on 2024-05-28 15:37

import base_app.models.compressed.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('track', models.FileField(max_length=255, upload_to=base_app.models.utils.DynamicPath('users/{track.uploaded_by_id}/tracks/{track.uuid}', ext='.opus', name='track', pass_as='track'), validators=[base_app.models.utils.FileValidator(content_types={'audio/x-m4a', 'audio/mpeg', 'audio/flac', 'audio/wav', 'audio/x-aiff', 'audio/ogg'}, max_size=1073741824), django.core.validators.FileExtensionValidator({'wav', 'mp2', 'flac', 'ogg', 'alac', 'aiff', 'opus', 'mp3'}, 'Invalid audio format valid formats are: wav, mp2, flac, ogg, alac, aiff, opus, mp3')], verbose_name='Track file')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('small', models.ImageField(blank=True, max_length=255, null=True, upload_to=base_app.models.compressed.models.CompImagePath(size='small'), verbose_name='Small Image')),
                ('medium', models.ImageField(blank=True, max_length=255, null=True, upload_to=base_app.models.compressed.models.CompImagePath(size='medium'), verbose_name='Medium Image')),
                ('large', models.ImageField(blank=True, max_length=255, null=True, upload_to=base_app.models.compressed.models.CompImagePath(size='large'), verbose_name='Large Image')),
                ('extracted_color', base_app.models.fields.ColorField(blank=True, null=True, verbose_name='Extracted Color')),
